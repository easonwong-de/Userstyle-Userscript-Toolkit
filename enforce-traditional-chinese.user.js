// ==UserScript==
// @name         Enforce Traditional Chinese
// @namespace    easonwong
// @supportURL   https://github.com/easonwong/
// @homepageURL  https://github.com/easonwong/
// @version      ver.2025-01-19
// @description  Replaces Simplified Chinese with Traditional Chinese
// @author       Eason (modified from hoothin's version)
// @match        *://*/*
// @grant        GM_setValue
// @grant        GM_getValue
...
(() => {
	...
	const site = "disable_conversion_" + location.hostname.toString().replace(/\./g, "_");
	...
	_unsafeWindow.sc2tc = convertString;
	...
	const contextualConversion = {
		巨: ["巨", ["鉅", "巨款", "巨富", "巨细靡遗", "巨子"]],
		折: ["折", ["摺", "折叠", "折纸", "存折", "对折", "折痕", "奏折", "折页", "折扇"]],
		霉: ["霉", ["黴", "霉菌", "霉素", "发霉"]],
		捆: ["捆", ["綑", "捆绑", "捆扎"]],
		涌: ["涌", ["湧", "汹涌", "涌起", "涌动", "风起云涌"]],
		升: ["升", ["昇", "升华", "提升", "高升", "歌舞升平", "升降", "直升"], ["陞", "升官", "升迁", "升任"]],
		划: ["劃", ["划", "划龙舟", "划船", "划算", "划不来"]],
		姜: ["姜", ["薑", "姜片", "姜葱", "生姜", "姜汁", "姜母鸭", "姜丝"]],
		御: ["禦", ["御", "御制", "御用", "御驾"]],
		...
		冲: ["沖", ["衝", "冲奖", "冲高", "冲决", "冲浪", "冲子", "冲力", "冲要", "冲破", "冲口", "冲顶", "冲床", "冲突", "冲刺", "冲金", "冲模", "冲撞", "冲腾", "冲锋", "冲量", "冲动", "冲程", "冲压", "冲杀", "冲激", "冲击", "俯冲", "反冲", "折冲", "缓冲", "脉冲", "要冲", "冲锋枪", "冲孔机", "冲劲", "冲金点", "冲压机", "冲击波", "反冲力", "冲锋", "横冲", "冲冠", "首当其冲"]],
		恶: ["惡", ["噁", "恶心"]],
		发: ["發／髮", ["發", "发回"], ["髮", "发网", "发际", "发箍", "发丝", "发式", "发带", "发型", "发卡", "发妻", "发指", "发廊", "发饰", "发乳", "发夹", "发菜", "发屋", "发姐", "发油", "发套", "发蜡", "发鬓", "发髻", "发雕", "发辫", "发胶", "发浆", "一发", "假发", "健发", "削发", "卷发", "握发", "束发", "染发", "植发", "栉发", "毛发", "毫发", "烫发", "理发", "白发", "短发", "秀发", "秃发", "结发", "美发", "胎发", "脱发", "华发", "落发", "蓄发", "护发", "金发", "银发", "头发", "驳发", "鬓发", "须发", "发小", "剃发令", "洗发", "发短心长", "怒发冲冠", "断发文身", "被发", "鹤发", "黄发垂髫", "擢发难数", "庞眉皓发", "披头散发", "间不容发"]],
		...
		捂: ["捂", ["摀", "紧捂"]],
		咸: ["鹹", ["咸", "咸阳", "咸宜", "咸丰", "咸和", "咸池", "咸五", "彭咸", "季咸", "阮咸", "阿咸", "巫咸", "碧咸"]],
		...
		游: ["遊", ["游", "游泳", "游水", "花游"]],
		弥: ["彌", ["瀰", "弥漫"]],
		松: ["松", ["鬆", "松糕", "松气", "鱼松", "肉松", "松心", "松软", "松紧", "松劲", "松动", "松开", "松落", "松绑", "松缓", "松嘴", "松土", "松泛", "松口", "松爽", "松散", "松弛", "松懈", "松快", "松手", "松厚", "松了", "松腻", "轻松", "放松", "松闲", "松松垮垮", "内紧外松"]],
	...
	const vocabularyConversion = {
		...
		/* Generic */
		隐私: "私隱", 塑料: "塑膠", 发卡: "髮夾", 舞娘: "舞孃", 秋千: "鞦韆", 拐杖: "枴杖", 胡同: "衚衕", 个旧: "箇舊", 朱砂: "硃砂", 估计: "猜測", 申根: "神根", 土豆: "薯仔", 梅西: "美斯", 简历: "履歷", 打伞: "擔遮", 打车: "叫車", 奔驰: "平治", 左拐: "轉左", 右拐: "轉右", 打包: "外帶", 外卖: "外送", 很火: "很紅", 包间: "卡位", 奶酪: "芝士", 盒饭: "飯盒", 夜宵: "宵夜", 冰棍: "冰棒", 格斗: "挌鬥", 献血: "捐血", 台球: "桌球", 蛙泳: "蛙式", 排插: "拖板", 输液: "吊鹽水", 豆腐脑: "豆花", 冰激淋: "雪糕", 西红柿: "蕃茄", 自行车: "單車", 出租车: "的士", 公交车: "巴士", 挺好的: "幾好的", 摩托车: "電單車", 幼儿园: "幼稚園", 公安局: "警察局", 换乘站: "轉車站", 猕猴桃: "奇異果", 西兰花: "椰菜花", 疯牛病: "狂牛病", 自由泳: "自由式", 够不到: "搆不到", 够不着: "搆不着", 维生素: "維他命", 特拉斯: "卓慧思", 洗面奶: "洗面乳", 洗发水: "洗髮乳", 打底裤: "内搭褲", 本科生: "大學生", 宇航员: "太空人", 超声波: "超音波", B超: "超音波檢查", 让一下: "唔該借歪", 创可贴: "藥水膠布", 保质期: "保存期限", 泰坦尼克: "鐵達尼", 知识产权: "智慧財產權",
		/* Northern dialect */
		啥: "乜", 咋: "點", 咱: "我哋", 甭: "唔使", 倒霉: "衰", 忽悠: "蝦", 牛B: "犀利", 傻B: "戇鳩", 逗B: "盞鬼", 咋办: "點算", 咋整: "點攪", 咋样: "點樣", 咱们: "我哋", 老哥: "大佬", 逗比: "盞鬼", 逗逼: "盞鬼", 牛逼: "犀利", 膈应: "核突", 搁这: "喺度", 傻逼: "戇鳩", 好歹: "橫豎", 胖子: "肥仔", 好使: "好用", 老铁: "手足", 挺: "挺（幾）", 啥玩意: "乜嘢", "挺（幾）": "挺（幾）",
		/* Place names */
	...
	function convertString(originalString) {
		...
		for (var i = 0; i < originalString.length; i++) {
			...
			let search = vocabularyConversionTree[char],
				searchIndex = i,
				hasMatch = false;
	...
	storage.getItem("vocabularyConversionTree", (vocabularyConversionTree_stored) => {
		if (!vocabularyConversionTree_stored) {
			for (const key in vocabularyConversion) {
				const value = vocabularyConversion[key];
				let curTree = vocabularyConversionTree;
			...
			storage.setItem("vocabularyConversionTree", vocabularyConversionTree);
		} else {
			vocabularyConversionTree = vocabularyConversionTree_stored;
		}
	});

	storage.getItem(site, (isConversionDisabled_stored) => {
		if (!isConversionDisabled_stored) run();
		if (window.top != window.self) return;
		_GM_registerMenuCommand(isConversionDisabled_stored ? "Re-enable on this site" : "Disable on this site", () => {
			isConversionDisabled = !isConversionDisabled_stored;
			storage.setItem(site, isConversionDisabled);
